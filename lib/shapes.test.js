...
describe('Shapes', () => {
  ...
  it('generates correct SVG for circle', async () => {
    ...
    const expectedPath = join(__dirname, '..', 'examples', 'circle.svg');
    const expectedContent = `<svg xmlns="http://www.w3.org/2000/svg" version="1.1" width = "300" height = "200" ><circle cx="150" cy="100" r="100" style="fill:red" /><text x="150" y="125" style="font-family: Arial; font-size: 40px; fill: orange; text-anchor: middle">ABC</text></svg>`;
